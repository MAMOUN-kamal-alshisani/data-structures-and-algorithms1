...
const checkValues = (obj, value) => {
  // Solution code here...
  let Theobj = Object.values(obj);
  if (Theobj.includes(value)) {
    return true;
  } else {
    return false;
  }
...
const updateNumbers = (obj) => {
  // Solution code here...
  let objects = Object.entries(obj).map((data) => data.join(": "));
...
const getHouses = (arr) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    let values = Object.values(arr[i].house);
